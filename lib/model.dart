...
Future<sherpa_onnx.OfflineTts> createOfflineTts() async {
  ...
  String modelDir = "vits-mimic3-fa-haaniye_low";
  String modelName = "fa-haaniye_low.onnx";
  String ruleFsts = '';
  String ruleFars = '';
  String lexicon = '';
  String dataDir = "vits-mimic3-fa-haaniye_low/espeak-ng-data";
  String dictDir = '';
  // You can select an example below and change it according to match your
  // selected tts model
  modelDir = 'vits-mimic3-fa-haaniye_low';
  modelName = 'fa-haaniye_low.onnx';
  dataDir = 'vits-mimic3-fa-haaniye_low/espeak-ng-data';
  // ============================================================
